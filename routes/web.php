...
Auth::routes();
//เราจะให้มันทำอะไรให้ไปตรงหน้าไหน
Route::get('/home', 'HomeController@index')->name('home');
Route::get('/post', 'PostController@post')->middleware('auth');
Route::get('/profile', 'ProfileController@profile')->middleware('auth');
Route::get('/profileme', 'ProfileMeController@profileme')->middleware('auth');
...
Route::get('/blog', 'BlogController@blog')->middleware('auth');
...
Route::get('/wel', 'WelController@index')->name('wel');
Route::get('/regens', 'RegensContoller@index')->name('regens');
