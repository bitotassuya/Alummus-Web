    ...
    public function addPost(Request $request){
    		...
    		$this->validate($request,[
    			...
    			$posts->category_id = $request->input('category_id');
    			 ...
    			 /*อย่าลืมต้องสร้าง floder posts ใน public ก่อน */
    			$url = URL::to("/"). '/posts/'
            ...
            public function category($cat_id){
              ...
              ->get();
              return view('categories.categoriesposts',['categories'=> $categories, 'posts'=>
              $posts]);
            }
            ...
            public function comment(Request $request,$post_id){
              ...
              $comment->save();
              return redirect("/view/{$post_id}")->with('response','Comment Succeed');
